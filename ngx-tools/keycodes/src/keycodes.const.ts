...
export const KEYS: Record<string, KeyCode> = {
  ...
  PAGE_UP: { code: 'PageUp', keyCode: 33 },
  PAGE_DOWN: { code: 'PageDown', keyCode: 34 },
  END: { code: 'End', keyCode: 35 },
  HOME: { code: 'Home', keyCode: 36 },
  LEFT_ARROW: { code: 'ArrowLeft', keyCode: 37 },
  UP_ARROW: { code: 'ArrowUp', keyCode: 38 },
  RIGHT_ARROW: { code: 'ArrowRight', keyCode: 39 },
  DOWN_ARROW: { code: 'ArrowDown', keyCode: 40 },
  DELETE: { code: 'Delete', keyCode: 46 },
  ZERO: { code: 'Digit0', keyCode: 48 },
  ONE: { code: 'Digit1', keyCode: 49 },
  TWO: { code: 'Digit2', keyCode: 50 },
  THREE: { code: 'Digit3', keyCode: 51 },
  FOUR: { code: 'Digit4', keyCode: 52 },
  FIVE: { code: 'Digit5', keyCode: 53 },
  SIX: { code: 'Digit6', keyCode: 54 },
  SEVEN: { code: 'Digit7', keyCode: 55 },
  EIGHT: { code: 'Digit8', keyCode: 56 },
  NINE: { code: 'Digit9', keyCode: 57 },
