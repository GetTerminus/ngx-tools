...
describe(`coerceNumberProperty`, () => {
  ...
  test(`should coerce an arbitrary string prefixed with a number to 0 or default`, () => {
  ...
  test(`should coerce an object to 0 or default`, () => {
    expect(coerceNumberProperty({})).toBe(0);
    expect(coerceNumberProperty({}, 111)).toBe(111);
  });


  test(`should coerce an array to 0 or default`, () => {
    expect(coerceNumberProperty([])).toBe(0);
    expect(coerceNumberProperty([], 111)).toBe(111);
  });
